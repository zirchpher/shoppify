    ...
    <div className="flex flex-col md:flex-row gap-4">
      ...
      >
        <div className="mb-4 flex h-48 items-center justify-center rounded bg-gray-300 dark:bg-gray-300">
          <svg
            className="h-12 w-12 text-gray-200 dark:text-gray-300"
        ...
        <div className="mt-4 flex h-5">
          <div className="mr-2 h-full w-2/3 bg-gray-300 rounded-lg "></div>
          <div className="h-full w-1/3 bg-gray-300 rounded-lg"></div>
        </div>
      </div>
